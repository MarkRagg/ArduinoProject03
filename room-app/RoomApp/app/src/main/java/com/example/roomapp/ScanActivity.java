    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case REQUEST_PERMISSION_CONNECT:
                ...
                logMessage("grantResult[0]: "+grantResults[0]);
                logMessage("PackageManager.PERMISSION_GRANTED: "+PackageManager.PERMISSION_GRANTED);
            ...
            case REQUEST_PERMISSION_ADMIN:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    displayError( "You need to grant bluetooth scan permission to use this featurrrrrre");
                }
                break;
